...
const seed: Seed[] = [
  // IRONMAN (DACH)
  {
    ...
    organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/im703-kraichgau',
  },
  {
    ...
    organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/im-hamburg',
  },
  {
    ...
    organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/im-european-championship-frankfurt',
  },
  // IRONMAN full-distance — Europe (dates verified via sportpress.international / IRONMAN)
  { id: 'se-im-lanzarote', name: 'IRONMAN Lanzarote', series: 'IRONMAN', town: 'Lanzarote', region: 'Spanien', country: 'ES', lat: 28.92, lon: -13.66, date: '2026-05-23T07:00:00', distances: [{ label: 'Langdistanz', ...IRONMAN }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im-klagenfurt', name: 'IRONMAN Austria Kärnten', series: 'IRONMAN', town: 'Klagenfurt', region: 'Österreich', country: 'AT', lat: 46.624, lon: 14.308, date: '2026-06-14T07:00:00', distances: [{ label: 'Langdistanz', ...IRONMAN }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im-tours', name: 'IRONMAN Tours Loire Valley', series: 'IRONMAN', town: 'Tours', region: 'Frankreich', country: 'FR', lat: 47.394, lon: 0.685, date: '2026-06-14T07:00:00', distances: [{ label: 'Langdistanz', ...IRONMAN }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im-nice', name: 'IRONMAN France Nice', series: 'IRONMAN', town: 'Nizza', region: 'Frankreich', country: 'FR', lat: 43.696, lon: 7.266, date: '2026-06-28T07:00:00', distances: [{ label: 'Langdistanz', ...IRONMAN }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im-thun', name: 'IRONMAN Switzerland Thun', series: 'IRONMAN', town: 'Thun', region: 'Schweiz', country: 'CH', lat: 46.758, lon: 7.628, date: '2026-07-05T07:00:00', distances: [{ label: 'Langdistanz', ...IRONMAN }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im-vichy', name: 'IRONMAN Vichy', series: 'IRONMAN', town: 'Vichy', region: 'Frankreich', country: 'FR', lat: 46.128, lon: 3.426, date: '2026-08-23T07:00:00', distances: [{ label: 'Langdistanz', ...IRONMAN }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im-wales', name: 'IRONMAN Wales', series: 'IRONMAN', town: 'Tenby', region: 'Großbritannien', country: 'GB', lat: 51.673, lon: -4.702, date: '2026-09-13T07:00:00', distances: [{ label: 'Langdistanz', ...IRONMAN }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im-emilia', name: 'IRONMAN Italy Emilia-Romagna', series: 'IRONMAN', town: 'Cervia', region: 'Italien', country: 'IT', lat: 44.262, lon: 12.354, date: '2026-09-19T07:00:00', distances: [{ label: 'Langdistanz', ...IRONMAN }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im-cascais', name: 'IRONMAN Portugal Cascais', series: 'IRONMAN', town: 'Cascais', region: 'Portugal', country: 'PT', lat: 38.697, lon: -9.421, date: '2026-10-17T07:00:00', distances: [{ label: 'Langdistanz', ...IRONMAN }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  // The big one — IRONMAN World Championship returns to Kona (men + women, one day, 10 Oct 2026)
  { id: 'se-im-worlds-kona', name: 'IRONMAN World Championship Hawaii', series: 'IRONMAN', town: 'Kailua-Kona', region: 'Hawaii, USA', country: 'US', lat: 19.639, lon: -155.997, date: '2026-10-10T06:25:00', distances: [{ label: 'Weltmeisterschaft · Langdistanz', ...IRONMAN }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/im-world-championship' },
  // IRONMAN 70.3 — Europe
  { id: 'se-im703-valencia', name: 'IRONMAN 70.3 Valencia', series: 'IRONMAN 70.3', town: 'Valencia', region: 'Spanien', country: 'ES', lat: 39.469, lon: -0.376, date: '2026-04-19T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-mallorca', name: 'IRONMAN 70.3 Alcúdia-Mallorca', series: 'IRONMAN 70.3', town: 'Alcúdia', region: 'Spanien', country: 'ES', lat: 39.853, lon: 3.121, date: '2026-05-09T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-aix', name: 'IRONMAN 70.3 Aix-en-Provence', series: 'IRONMAN 70.3', town: 'Aix-en-Provence', region: 'Frankreich', country: 'FR', lat: 43.529, lon: 5.448, date: '2026-05-17T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-rapperswil', name: 'IRONMAN 70.3 Switzerland Rapperswil', series: 'IRONMAN 70.3', town: 'Rapperswil-Jona', region: 'Schweiz', country: 'CH', lat: 47.226, lon: 8.818, date: '2026-06-07T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-nice', name: 'IRONMAN 70.3 Nice', series: 'IRONMAN 70.3', town: 'Nizza', region: 'Frankreich', country: 'FR', lat: 43.696, lon: 7.266, date: '2026-06-28T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-lessables', name: 'IRONMAN 70.3 Les Sables d’Olonne', series: 'IRONMAN 70.3', town: 'Les Sables-d’Olonne', region: 'Frankreich', country: 'FR', lat: 46.497, lon: -1.783, date: '2026-07-05T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-vitoria', name: 'IRONMAN 70.3 Vitoria-Gasteiz', series: 'IRONMAN 70.3', town: 'Vitoria-Gasteiz', region: 'Spanien', country: 'ES', lat: 42.846, lon: -2.672, date: '2026-07-12T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-duisburg', name: 'IRONMAN 70.3 Duisburg', series: 'IRONMAN 70.3', town: 'Duisburg', region: 'Nordrhein-Westfalen', country: 'DE', lat: 51.435, lon: 6.762, date: '2026-08-16T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-leipzig', name: 'IRONMAN 70.3 Leipzig', series: 'IRONMAN 70.3', town: 'Leipzig', region: 'Sachsen', country: 'DE', lat: 51.34, lon: 12.375, date: '2026-08-23T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-vichy', name: 'IRONMAN 70.3 Vichy', series: 'IRONMAN 70.3', town: 'Vichy', region: 'Frankreich', country: 'FR', lat: 46.128, lon: 3.426, date: '2026-08-23T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-zellamsee', name: 'IRONMAN 70.3 Zell am See-Kaprun', series: 'IRONMAN 70.3', town: 'Zell am See', region: 'Österreich', country: 'AT', lat: 47.323, lon: 12.798, date: '2026-08-30T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-wc-nice', name: 'IRONMAN 70.3 Weltmeisterschaft', series: 'IRONMAN 70.3', town: 'Nizza', region: 'Frankreich', country: 'FR', lat: 43.696, lon: 7.266, date: '2026-09-12T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-erkner', name: 'IRONMAN 70.3 Erkner (Berlin)', series: 'IRONMAN 70.3', town: 'Erkner', region: 'Brandenburg', country: 'DE', lat: 52.425, lon: 13.752, date: '2026-09-13T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  { id: 'se-im703-malaga', name: 'IRONMAN 70.3 Málaga', series: 'IRONMAN 70.3', town: 'Málaga', region: 'Spanien', country: 'ES', lat: 36.721, lon: -4.421, date: '2026-10-18T08:00:00', distances: [{ label: 'Mitteldistanz (70.3)', ...HALF }], organizer: 'IRONMAN', websiteUrl: 'https://www.ironman.com/races' },
  // Challenge Family
  {
