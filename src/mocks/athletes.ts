...
export const athletes: Athlete[] = [
  ...
  { id: 'patrick-lange', name: 'Patrick Lange', country: 'DE', gender: 'men', series: ['ironman', 'ironman703', 't100'], bio: 'Mehrfacher Ironman-Weltmeister (Kona).' },
  { id: 'frederic-funk', name: 'Frederic Funk', country: 'DE', gender: 'men', series: ['t100', 'pto', 'ironman703', 'ironman'], bio: 'T100- und Mitteldistanz-Star.' },
  { id: 'jan-frodeno', name: 'Jan Frodeno', country: 'DE', gender: 'men', series: ['ironman'], bio: 'Triathlon-Legende, 3× Ironman-Weltmeister & Olympiasieger.' },
  { id: 'sebastian-kienle', name: 'Sebastian Kienle', country: 'DE', gender: 'men', series: ['ironman', 'ironman703'], bio: 'Ironman-Weltmeister 2014.' },
  ...
  { id: 'mika-noodt', name: 'Mika Noodt', country: 'DE', gender: 'men', series: ['ironman', 'ironman703', 'pto'] },
  { id: 'jonas-hoffmann', name: 'Jonas Hoffmann', country: 'DE', gender: 'men', series: ['ironman703'] },
  { id: 'maurice-clavel', name: 'Maurice Clavel', country: 'DE', gender: 'men', series: ['ironman', 'pto'] },
  { id: 'franz-loeschke', name: 'Franz Löschke', country: 'DE', gender: 'men', series: ['ironman703'] },
  { id: 'marc-dubrick', name: 'Marc Dubrick', country: 'DE', gender: 'men', series: ['ironman703', 't100'] },
  // — Deutsche Stars: Kurzdistanz (WTCS) —
  { id: 'tim-hellwig', name: 'Tim Hellwig', country: 'DE', gender: 'men', series: ['wtcs'] },
  { id: 'jonas-schomburg', name: 'Jonas Schomburg', country: 'DE', gender: 'men', series: ['wtcs'] },
  { id: 'lasse-luehrs', name: 'Lasse Lührs', country: 'DE', gender: 'men', series: ['wtcs'] },
  { id: 'lasse-nygaard-priester', name: 'Lasse Nygaard-Priester', country: 'DE', gender: 'men', series: ['wtcs'] },
  { id: 'simon-henseleit', name: 'Simon Henseleit', country: 'DE', gender: 'men', series: ['wtcs'] },
  { id: 'justus-nieschlag', name: 'Justus Nieschlag', country: 'DE', gender: 'men', series: ['wtcs'] },
  // — Deutsche Frauen: Langdistanz —
  { id: 'anne-haug', name: 'Anne Haug', country: 'DE', gender: 'women', series: ['ironman', 'ironman703', 't100'], bio: 'Ironman-Weltmeisterin 2019.' },
  { id: 'laura-philipp', name: 'Laura Philipp', country: 'DE', gender: 'women', series: ['ironman', 'ironman703', 't100'], bio: 'Ironman-Weltmeisterin 2024.' },
  ...
  { id: 'lisa-tertsch', name: 'Lisa Tertsch', country: 'DE', gender: 'women', series: ['wtcs', 'ironman703'] },
  ...
  { id: 'leo-bergere', name: 'Léo Bergère', country: 'FR', gender: 'men', series: ['wtcs'] },
  { id: 'dorian-coninx', name: 'Dorian Coninx', country: 'FR', gender: 'men', series: ['wtcs'], bio: 'Weltmeister 2023.' },
  { id: 'vincent-luis', name: 'Vincent Luis', country: 'FR', gender: 'men', series: ['wtcs'] },
  ...
  { id: 'jelle-geens', name: 'Jelle Geens', country: 'BE', gender: 'men', series: ['wtcs', 'ironman703'] },
  ...
  { id: 'alistair-brownlee', name: 'Alistair Brownlee', country: 'GB', gender: 'men', series: ['wtcs', 'ironman703'], bio: '2× Olympiasieger.' },
  { id: 'jonathan-brownlee', name: 'Jonathan Brownlee', country: 'GB', gender: 'men', series: ['wtcs'] },
  { id: 'javier-gomez', name: 'Javier Gómez', country: 'ES', gender: 'men', series: ['wtcs', 'ironman703'], bio: '5× Weltmeister.' },
  { id: 'mario-mola', name: 'Mario Mola', country: 'ES', gender: 'men', series: ['wtcs'] },

  // — International: Langdistanz / PTO Männer —
  { id: 'kristian-blummenfelt', name: 'Kristian Blummenfelt', country: 'NO', gender: 'men', series: ['ironman', 't100', 'pto', 'wtcs'], bio: 'Olympiasieger & Ironman-Weltmeister.' },
  { id: 'gustav-iden', name: 'Gustav Iden', country: 'NO', gender: 'men', series: ['ironman', 'ironman703'] },
  { id: 'sam-laidlow', name: 'Sam Laidlow', country: 'FR', gender: 'men', series: ['ironman'], bio: 'Ironman-Weltmeister 2023.' },
  { id: 'magnus-ditlev', name: 'Magnus Ditlev', country: 'DK', gender: 'men', series: ['ironman', 't100', 'pto'] },
  { id: 'lionel-sanders', name: 'Lionel Sanders', country: 'CA', gender: 'men', series: ['ironman', 'ironman703', 't100'] },
  { id: 'leon-chevalier', name: 'Leon Chevalier', country: 'FR', gender: 'men', series: ['ironman'] },
  ...
  { id: 'trevor-foley', name: 'Trevor Foley', country: 'US', gender: 'men', series: ['ironman', 't100'] },
  ...
  { id: 'pieter-heemeryck', name: 'Pieter Heemeryck', country: 'BE', gender: 'men', series: ['ironman'] },
  ...
  { id: 'mathis-margirier', name: 'Mathis Margirier', country: 'FR', gender: 'men', series: ['ironman703'] },
  ...
  { id: 'flora-duffy', name: 'Flora Duffy', country: 'BM', gender: 'women', series: ['wtcs'], bio: 'Olympiasiegerin 2021.' },
  { id: 'taylor-knibb', name: 'Taylor Knibb', country: 'US', gender: 'women', series: ['wtcs', 'ironman703', 't100'] },
  { id: 'emma-lombardi', name: 'Emma Lombardi', country: 'FR', gender: 'women', series: ['wtcs', 't100'] },
  ...
  { id: 'kate-waugh', name: 'Kate Waugh', country: 'GB', gender: 'women', series: ['wtcs'] },
  ...
  // — International: Langdistanz / PTO Frauen —
  ...
  { id: 'kat-matthews', name: 'Kat Matthews', country: 'GB', gender: 'women', series: ['ironman', 't100', 'pto'] },
  { id: 'chelsea-sodaro', name: 'Chelsea Sodaro', country: 'US', gender: 'women', series: ['ironman'], bio: 'Ironman-Weltmeisterin 2022.' },
  { id: 'ashleigh-gentle', name: 'Ashleigh Gentle', country: 'AU', gender: 'women', series: ['t100', 'pto', 'ironman703'] },
  { id: 'daniela-ryf', name: 'Daniela Ryf', country: 'CH', gender: 'women', series: ['ironman', 'ironman703'], bio: '5× Ironman-Weltmeisterin.' },
  { id: 'paula-findlay', name: 'Paula Findlay', country: 'CA', gender: 'women', series: ['t100', 'pto'] },
  ...
  { id: 'els-visser', name: 'Els Visser', country: 'NL', gender: 'women', series: ['ironman'] },
